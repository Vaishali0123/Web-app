...
export default function ChatLayout({ children }) {
  ...
  return (
    ...
    <div className="h-[100vh] w-[100%] bg-white dark:bg-[#171717] flex pn:max-md:justify-center ">
      {/* chats */}
      {/* Chat header */}
      <div className="h-[100vh] select-none pn:max-md:w-[100%] md:min-w-[390px] md:[360px] flex flex-col items-center pb-20 pn:max-sm:pt-16 md:border-r-2 border-[#f7f7f7] dark:border-[#2b2b2b]  overflow-auto scrollbar-hide ">
        <div className="w-[100%] h-[100px] flex flex-row px-5 justify-between items-center pn:max-md:h-[8%] ">
          <div className="text-[24px] text-black font-sans font-semibold dark:text-[#fff]">
            Chats
          </div>
          <div className="text-[14px] text-black font-sans font-medium bg-slate-100 rounded-2xl h-8 w-20 animate-pulse">
        
      </div>
        </div>
        {/* messages */}
        <div className="w-[100%]  overflow-auto pn:max-md:h-[92%] h-[100vh] flex flex-col px-2">
          {/* one chat */}
